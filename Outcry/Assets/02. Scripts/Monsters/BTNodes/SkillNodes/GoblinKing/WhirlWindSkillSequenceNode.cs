...
public class WhirlWindSkillSequenceNode : SkillSequenceNode
{
    ...
    protected override NodeState SkillAction()
    {
        ...
        if (!skillTriggered)
        {
            ...
            FlipCharacter();
            monster.Animator.SetTrigger(AnimatorStrings.MonsterParameter.WhirlWind);
        ...
        bool isSkillAnimationPlaying = IsSkillAnimationPlaying(AnimatorStrings.MonsterAnimation.WhirlWind);
